      ...
      <Stack spacing={4} padding={2} paddingBottom={0}>
        ...
        <Stack  key={item.id} spacing={2} padding={0}>
          ...
          >
            ...
            <Typography variant="h4" color={"#79001D"} marginTop={1} fontWeight={600}>{item.price}</Typography>{" "}
          
          </Stack>

          <Divider />
        </Stack>  ))}
      </Stack><StyledFilter open={filterOpen} onClose={handleCloseFilter} />
    </Box>
  );
};
